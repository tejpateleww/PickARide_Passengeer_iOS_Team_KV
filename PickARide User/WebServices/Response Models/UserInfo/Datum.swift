...
class Datum : NSObject, NSCoding{
	...
	init(fromJson json: JSON!){
        ...
        earnedSar = json["earned_sar"].stringValue
        ...
        loginAt = json["LoginAt"].stringValue
	...
	func toDictionary() -> [String:Any]
	{
        ...
        if earnedSar != nil{
        	dictionary["earned_sar"] = earnedSar
        }
        if email != nil{
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
		...
		earnedSar = aDecoder.decodeObject(forKey: "earned_sar") as? String
		...
		loginAt = aDecoder.decodeObject(forKey: "LoginAt") as? String
    ...
    */
    func encode(with aCoder: NSCoder)
	{
		...
		if earnedSar != nil{
			aCoder.encode(earnedSar, forKey: "earned_sar")
		}
		if email != nil{
		...
		if loginAt != nil{
			aCoder.encode(loginAt, forKey: "LoginAt")
		}
		if longitude != nil{
