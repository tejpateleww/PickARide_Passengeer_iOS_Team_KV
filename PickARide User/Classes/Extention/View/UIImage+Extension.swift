...
extension UIImage{
    ...
    enum AssetIdentifier: String{
        case amex = "imgAmex"
        case dinersClub = "imgDinersClub"
        case discover = "imgDiscover"
        case jcb = "imgJcb"
        case maestro = "imgMaestro"
        case master = "imgMaster"
        case visa = "imgVisa"
        case none = "imgCards"
    }
...
extension UIImageView{
    func loadSDImage(prefixStr: String = APIEnvironment.Profilebu.rawValue, imgUrl : String, isUserProfile: Bool = true){
