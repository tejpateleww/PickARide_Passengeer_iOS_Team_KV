...
class Toast {
    ...
    static func show(title: String = "" ,delay :Double = 1.5,  message: String, state : MessageAlertState ,  completion: (() -> Void)? = nil) {
        ...
        case .info:
            toastContainer.backgroundColor = ThemeColorEnum.ThemeGray.rawValue//.withAlphaComponent(0.9) //UIColor(red: 225.0/255.0, green: 225.0/255.0, blue: 225.0/255.0, alpha: 1.0)
